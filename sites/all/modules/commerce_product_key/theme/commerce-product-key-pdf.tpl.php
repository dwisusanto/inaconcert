...
<table width="400" style="margin:10px auto; background:#ffffff;" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="80" style="text-align:center; font-size:44px; font-weight:bold;"><?php print $event['title']; ?></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="175"	style="font-size:20px; font-weight:bold; text-decoration:underline;">
    </td>
  </tr>
<?php foreach ($product as $prod) { ?>
  <tr>
    <td width="175" height="100" style="font-size:33px; font-weight:bold; text-decoration:underline;">
...
<?php } ?>
  ...
  <tr>
    <td>
    	<table width="400" border="0" cellspacing="0" cellpadding="5"  style="margin:20px auto; text-align:center; font-size:24px;">
              <tr>
